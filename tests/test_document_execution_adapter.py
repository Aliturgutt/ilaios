"""Creative/Document coordinator E2E for governed PDF and DOCX outputs."""
...
def test_document_outputs_flow_through_coordinator_and_remain_tenant_scoped(
    ...
    assert prepared["adapter_id"] == "document.product-runtime.pdf-docx.v1"
    ...
    assert manifest["evidence_scope"] == "GOVERNED_PDF_DOCX_FILES_OUTPUTS"
    ...
    assert set(by_type) == {"document.pdf", "document.docx"}
