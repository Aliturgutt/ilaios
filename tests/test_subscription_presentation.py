...
def test_page_and_assets_render(tmp_path: Path) -> None:
    ...
    for locale, title in (
        ...
        assert b"account-actions-grid .current>div:last-child{display:flex;align-items:center;gap:14px;flex-wrap:wrap;margin-top:auto}" in css
        ...
        assert b"management .actions{justify-content:flex-start;margin-top:auto}" in css
