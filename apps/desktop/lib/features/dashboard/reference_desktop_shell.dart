                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 13.5,
                        color: selected ? IlaiosTheme.enterpriseCyan : scheme.onSurface,
            ...
            Row(
              children: [
                ...
                Icon(
                  Icons.circle,
                  size: 7,
                  color: connected ? IlaiosTheme.success : Theme.of(context).colorScheme.outline,
                ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: IlaiosTheme.enterpriseCyan.withValues(alpha: .24)),
              ),
              child: const Icon(
        ...
        child: Row(
          children: [
            _StatusChip(
              ...
              accent: projection.connected ? IlaiosTheme.success : Theme.of(context).colorScheme.outline,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                value,
                style: TextStyle(color: accent, fontSize: 10.3, fontWeight: FontWeight.w700),
              ),
            ],
          ),
        ),
