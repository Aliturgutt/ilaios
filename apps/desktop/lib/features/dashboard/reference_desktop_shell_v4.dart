...
class ReferenceDesktopShellV4 extends StatefulWidget {
  const ReferenceDesktopShellV4({
  ...
  @override
  State<ReferenceDesktopShellV4> createState() => _ReferenceDesktopShellV4State();
}

class _ReferenceDesktopShellV4State extends State<ReferenceDesktopShellV4> {
  ...
  Widget build(BuildContext context) => LayoutBuilder(
        builder: (context, constraints) {
          ...
          final compact = constraints.maxWidth < 1180 ||
              ...
              (textScale >= 1.45 && constraints.maxWidth < 1450);
...
class _Sidebar extends StatelessWidget {
  ...
  static const _symbol = '../../brand/assets/03-ilaios-symbol-dark.jpg';
  ...
  Widget build(BuildContext context) => Semantics(
        ...
        child: Container(
          key: const Key('reference-desktop-sidebar-v4'),
          width: 250,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(context.tr('shell.tenant'), style: const TextStyle(fontSize: 8.8)),
            ...
            children: [
              Expanded(
                child: Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(fontSize: 9.6, fontWeight: FontWeight.w700),
                ),
              ),
              Icon(
                Icons.circle,
          ...
          const SizedBox(height: 7),
          Text(_isTr(context) ? 'Bölge' : 'Region', style: const TextStyle(fontSize: 8.5)),
...
class _TopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        key: const Key('reference-desktop-topbar-v4'),
        height: 80,
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(context.tr('shell.project'), style: const TextStyle(fontSize: 9)),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: Align(
                  ...
                  child: Text(context.tr('shell.search'), style: const TextStyle(fontSize: 9.5)),
                ),
              ),
            ),
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: const Icon(Icons.person_outline_rounded, size: 18, color: IlaiosTheme.enterpriseCyan),
                  ),
                  const SizedBox(width: 8),
                  SizedBox(
                    width: 150,
...
class _BottomStatusBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final queues = _authoritativeCount(snapshot.schedulerState, const ['queue_count', 'queues']);
    final eventsPerMinute = _runtimeText(snapshot, const ['events_per_minute', 'event_rate']);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _StatusChip(label: context.tr('shell.workers'), value: '$leases'),
          const SizedBox(width: 10),
          _StatusChip(label: context.tr('shell.queues'), value: queues ?? '—'),
          const SizedBox(width: 10),
          _StatusChip(label: context.tr('shell.eventsPerMinute'), value: eventsPerMinute ?? '—'),
          const Spacer(),
          Text('© 2026 ILAIOS', style: TextStyle(fontSize: 8.7, color: Theme.of(context).colorScheme.onSurfaceVariant)),
          const Spacer(),
          Row(
            children: [
              Text(context.tr('shell.realTime'), style: const TextStyle(fontSize: 9)),
...
class _StatusChip extends StatelessWidget {
  const _StatusChip({required this.label, required this.value, this.live = false});
  final String label;
  final String value;
  final bool live;
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(value, style: const TextStyle(fontSize: 8.8, fontWeight: FontWeight.w700)),
          ],
        ),
      );
}

bool _isTr(BuildContext context) => IlaiosLocaleScope.of(context).locale == IlaiosLocale.turkish;
...
String? _projectLabel(OperationalSnapshot snapshot) {
  ...
  return _text(event, const ['project_name', 'project', 'goal', 'objective', 'job_id']);
}
