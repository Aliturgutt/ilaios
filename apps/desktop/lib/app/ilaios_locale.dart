...
abstract final class IlaiosStrings {
  static const Map<String, String> _en = <String, String>{
    ...
    'videoReferences.dock': 'Video references',
    'videoReferences.title': 'Video references',
    ...
    'videoReferences.optional': 'Optional: add subject, product, style, environment, logo or storyboard references.',
    'videoReferences.privacy': 'Images are not published as public URLs. Normalized copies are sent to the configured free vision provider; local raw copies are released after successful generation.',
    'videoReferences.dialogTitle': 'Reference image instructions',
    'videoReferences.role': 'Role',
    'videoReferences.howUse': 'How should Video Factory use this image?',
    'videoReferences.hint': 'Example: Keep this product shape, materials and logo placement consistent.',
  ...
  static const Map<String, String> _tr = <String, String>{
    ...
    'videoReferences.dock': 'Video referansları',
    'videoReferences.title': 'Video referansları',
    ...
    'videoReferences.optional': 'İsteğe bağlı: konu, ürün, stil, ortam, logo veya storyboard referansları ekle.',
    'videoReferences.privacy': 'Görseller herkese açık URL olarak yayımlanmaz. Normalize edilmiş kopyalar yapılandırılmış ücretsiz görsel sağlayıcısına gönderilir; yerel ham kopyalar başarılı üretimden sonra serbest bırakılır.',
    'videoReferences.dialogTitle': 'Referans görsel talimatları',
    'videoReferences.role': 'Rol',
    'videoReferences.howUse': 'Video Factory bu görseli nasıl kullanmalı?',
    'videoReferences.hint': 'Örnek: Bu ürünün şeklini, malzemelerini ve logo yerleşimini tutarlı koru.',
