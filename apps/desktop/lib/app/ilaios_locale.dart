...
abstract final class IlaiosStrings {
  static const Map<String, String> _en = <String, String>{
    ...
    'videoReferences.privacy': 'Reference images are never published as public URLs. Web Factory embeds admitted images only into the generated local source; Video Factory may send normalized copies to the configured vision provider for visual conditioning.',
  ...
  static const Map<String, String> _tr = <String, String>{
    ...
    'videoReferences.privacy': 'Referans görseller hiçbir zaman herkese açık URL olarak yayımlanmaz. Web Factory kabul edilen görselleri yalnızca üretilen yerel kaynağa ekler; Video Factory görsel koşullandırma için normalize edilmiş kopyaları yapılandırılmış görsel sağlayıcısına gönderebilir.',
