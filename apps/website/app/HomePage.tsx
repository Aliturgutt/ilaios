...
const copy = {
  en: {
    ...
    outcomesTitle: "One governed product. Nine kinds of production work.",
    outcomesLead: "Choose the result you need. ILAIOS coordinates the applicable production area while identity, policy, approvals, state and evidence remain under the same control model.",
    outcomes: [
      ["Website", "Responsive website production and revisions with browser, accessibility and release checks.", "/factories/web"],
      ["Video / Media", "Reference-driven media production spanning script, assets, render and quality validation.", "/factories/video"],
      ["Software", "Bounded repository engineering with reviewed code, tests and change evidence.", "/factories/software"],
      ["Application", "Application planning, build and test work inside explicit release boundaries.", "/factories/app"],
      ...
      ["Personal Operations", "Repeatable personal workflows with consequential side effects governed separately.", "/factories/personal-operations"],
    ],
    ...
    controlLead: "Identity, permissions, approvals and evidence remain part of the ILAIOS control model. The complete system map lives in Architecture; the product experience stays outcome-first.",
  ...
  tr: {
    ...
    outcomesTitle: "Tek yönetilen ürün. Dokuz üretim alanı.",
    outcomesLead: "İhtiyacın olan sonucu seç. ILAIOS ilgili üretim alanını koordine eder; kimlik, politika, onaylar, durum ve kanıt aynı kontrol modeli altında kalır.",
    outcomes: [
      ["Web sitesi", "Responsive web sitesi üretimi ve revizyonları; tarayıcı, erişilebilirlik ve yayın kontrolleriyle.", "/tr/factories/web"],
      ["Video / Medya", "Referans odaklı medya üretimi; senaryo, varlıklar, render ve kalite doğrulamasıyla.", "/tr/factories/video"],
      ["Yazılım", "Sınırları belirli repository mühendisliği; incelenmiş kod, test ve değişiklik kanıtıyla.", "/tr/factories/software"],
      ["Uygulama", "Açık release sınırları içinde uygulama planlama, build ve test çalışması.", "/tr/factories/app"],
      ["Araştırma & Veri", "Kaynak temelli araştırma ve incelenebilir provenance ile yapılandırılmış analiz.", "/tr/factories/research-data"],
      ["Güvenlik", "Açık yetki ve kapsam içinde savunma amaçlı değerlendirme ve düzeltme çalışması.", "/tr/factories/security"],
      ["Creative / Doküman", "Kontrollü doküman oluşturma, doğrulama ve incelenebilir export yolları.", "/tr/factories/creative-document"],
      ["Commerce / Growth", "Kanıta dayalı büyüme önerileri ve inceleme kapılı ticari çalışmalar.", "/tr/factories/commerce-growth"],
      ["Kişisel Operasyon", "Sonuç doğuran dış etkileri ayrıca yönetilen tekrarlanabilir kişisel iş akışları.", "/tr/factories/personal-operations"],
    ],
    ...
    controlLead: "Kimlik, izinler, onaylar ve kanıt ILAIOS kontrol modelinin parçası olarak kalır. Tam sistem haritası Mimari sayfasında bulunur; ürün deneyimi sonuç odaklı kalır.",
