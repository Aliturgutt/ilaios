...
const copy = {
  en: {
    ...
    processTitle: "The user sees a simple request. The platform keeps the controls explicit.",
    process: [["01", "Goal", "Authenticated intent enters the system."], ["02", "Plan", "Context, policy and dependencies define the path."], ["03", "Execute", "Bounded capabilities perform the admitted work."], ["04", "Validate", "Tests and acceptance criteria evaluate the result."], ["05", "Deliver", "Accepted work is surfaced with reviewable evidence."]],
    archEyebrow: "System language",
    archTitle: "Governed execution becomes visible, not hidden behind a chat response.",
  ...
  tr: {
    ...
    lead: "Kimliği doğrulanmış tek bir hedef; planlama, sınırlandırılmış yürütme, doğrulama ve kanıt üzerinden bitmiş dijital ürüne ilerleyebilir.",
    ...
    processTitle: "Kullanıcı basit bir istek görür. Platform kontrolleri açık tutar.",
    ...
    archTitle: "Yönetilen yürütme, sohbet yanıtının arkasına saklanmak yerine görünür olur.",
    archText: "Hedef → Politika → Yönlendirici → Üretim → Doğrulama → Kanıt → Sonuç, ürünün görsel ve operasyonel omurgasıdır.",
...
export default function HomePage({ locale }: { locale: Locale }) {
  ...
  return <>
    ...
    <section className="section"><div className="shell architecture-story">
