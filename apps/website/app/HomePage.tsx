...
const copy = {
  en: {
    ...
    outcomesTitle: "The four interactive examples are only part of ILAIOS.",
    outcomesLead: "Web, video, software and applications are the clearest product examples. ILAIOS also has governed production areas for research and data, security, creative documents, commerce and growth, and personal operations.",
  ...
  tr: {
    ...
    outcomesTitle: "Dört etkileşimli örnek ILAIOS'un yalnızca bir bölümünü gösterir.",
    outcomesLead: "Web sitesi, video, yazılım ve uygulama en açık ürün örnekleridir. ILAIOS ayrıca araştırma ve veri, güvenlik, yaratıcı dokümanlar, ticaret ve büyüme ile kişisel operasyonlar için yönetilen üretim alanlarına sahiptir.",
