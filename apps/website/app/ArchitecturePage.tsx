...
const copy = {
  en: {
    ...
    executionVisualLead: "Factory orchestration happens before worker/provider routing; material steps create evidence and state during execution rather than only at the end.",
    ...
    knowledgeText: "Authorized context, provenance and purpose-aware retrieval are part of the contract; RAG is not merely embeddings or a vector database.",
  ...
  tr: {
    ...
    executionVisualLead: "Factory orkestrasyonu worker/sağlayıcı yönlendirmesinden önce gelir; önemli adımlar kanıtı ve durumu yalnız sonda değil yürütme sırasında üretir.",
    ...
    knowledgeText: "Yetkili bağlam, provenance ve amaç duyarlı retrieval sözleşmenin parçasıdır; RAG yalnız embeddings veya vector database değildir.",
