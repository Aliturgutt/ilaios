...
export default function ArchitecturePage({ locale }: { locale: Locale }) {
  ...
  return <>
    ...
    <section className="section"><div className="shell knowledge-band"><div><div className="eyebrow">Knowledge / RAG</div><h2>{c.knowledgeTitle}</h2></div><p>{c.knowledgeText}</p></div></section>
