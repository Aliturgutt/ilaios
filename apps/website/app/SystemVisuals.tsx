...
const copy = {
  ...
  tr: {
    ...
    execution: {
      ...
      nodes: [
        ["Hedef", "Kimliği doğrulanmış niyet", "Oturum açmış kullanıcının istediği sonucu, kiracı/proje bağlamını ve kabul kriterlerini alır; kendi kendine ek yetki üretmez."],
        ...
        ["Üretim", "Sınırlandırılmış iş akışı", "Onaylı alan akışını uygun yerleşik üretim alanı ve yönetilen yürütme yolu üzerinden çalıştırır."],
        ...
        ["Kanıt", "İncelenebilir kanıt", "Doğrulama sonuçlarını, kaynak kökeni bilgisini ve yürütme soyunu koruyarak sonucu incelenebilir ve eşleştirilebilir tutar."],
    ...
    planes: {
      ...
      control: [
        ["Kimlik ve kiracı", "Kimin, hangi sınır içinde işlem yaptığı", "Kimliği doğrulanmış kullanıcı, kiracı ve proje sınırını kurar; sonraki tüm iş bu sınırı korur."],
        ...
        ["Durum ve kurtarma", "Neyin kalıcı, devam ettirilebilir ve sınırlandırılmış olduğu", "Kontrol noktalarını, devam ettirilebilir durumu ve onarım sınırlarını açık tutarak sonsuz otonom döngüyü engeller."],
      ],
      executionPlane: [
        ["Üretim alanı orkestrasyonu", "Alan iş akışı / DAG", "Kabul edilmiş planı ve kabul sözleşmesini kullanarak seçilen alan üretim yolunu yürütür."],
        ["Yetenek ve araçlar", "Gereken en düşük yetenek kapsamı", "Yalnız kabul edilmiş iş için gereken yetenekleri kullanır ve araç kapsamını sınırlandırılmış tutar."],
        ["Model ve sağlayıcılar", "Değiştirilebilir yürütme kaynakları", "Akıl yürütme veya üretim kapasitesi sağlar; ancak platform yetkisinin altında ve değiştirilebilir kalır."],
        ["Doğrulama ve kanıt", "Kesin sonuç sürümüne bağlı kanıt", "Üretilen çıktıyı kontrol eder ve incelenebilir kanıtı kesin kabul edilmiş sonuçla eşleştirir."],
      ],
    },
    factory: {
      label: "Üretim alanı yaşam döngüsü",
      title: "Üretim alanları paralel çalışma zamanları değil, sınırlandırılmış üretim yollarıdır.",
      text: "Her yerleşik üretim alanı aynı yetki, yönlendirme, doğrulama, kanıt ve kurtarma modelini kullanır; yalnızca alan iş akışı uzmanlaşır.",
      steps: [
        ...
        ["Yürütme", "Seçilen üretim alanı yolunu yalnız kabul edilmiş yetenek, araç ve sağlayıcılarla çalıştırır."],
        ["Doğrulama", "Çıktıya deterministik kontrolleri, güvenlik kapılarını ve kabul kriterlerini uygular."],
        ["Teslim", "Kabul edilmiş sonucu kanıtıyla döndürür; çözülemeyen iş durur veya sınırlandırılmış onarıma girer."],
      ],
    },
    trust: {
      label: "Güven sınırı",
      ...
      nodes: [
        ...
        ["Yetkili kontrol katmanı", "Kimlik · politika · kapsam · onaylar", "Platform izinler, politika, yürütme kabulü, durum ve kabul sınırlarının yetkili kaynağı olarak kalır."],
        ["Dış sistem etkisi", "Yalnız doğrulama ve kabul sonrasında", "Yayınlama, değişiklik veya diğer dış etkiler yalnız kabul edilmiş yetki içinde ve gerekli kapılar geçildikten sonra gerçekleşir."],
      ],
    },
  },
} as const;
