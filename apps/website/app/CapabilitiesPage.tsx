...
const copy = {
  en: {
    ...
    exampleTitle: "A product launch can move from research to production without becoming a stack of separate workflows for the user.",
    ...
    productionEyebrow: "Nine production areas",
    productionTitle: "The same capabilities support nine bounded production areas.",
    ...
    all: "Explore all production areas",
  ...
  tr: {
    ...
    exampleTitle: "Bir ürün lansmanı, kullanıcı için ayrı ayrı iş akışlarına dönüşmeden araştırmadan üretime ilerleyebilir.",
    ...
    productionEyebrow: "Dokuz üretim alanı",
    productionTitle: "Aynı yetenekler dokuz sınırlandırılmış üretim alanını destekler.",
    ...
    all: "Tüm üretim alanlarını keşfet",
