...
const copy = {
  en: {
    ...
    factoryData: [
      ...
      { name: "App", description: "Application planning and bounded production work; broader mobile and Store paths remain gated separately.", status: "preview", statusLabel: "Preview", href: "/factories/app", example: "Plan and build a governed appointment application and prepare its release-readiness checklist." },
      ...
      { name: "Creative / Document", description: "Controlled document composition and reviewable export paths.", status: "development", statusLabel: "In development", href: "/factories/creative-document", example: "Turn these approved source documents into a reviewable executive report." },
  ...
  tr: {
    ...
    truth: "Erişilebilirlik etiketleri bilinçli olarak ihtiyatlıdır; her sağlayıcı veya yayın yolunun üretimde doğrulanmış olduğu anlamına gelmez.",
    ...
    factoryData: [
      { name: "Web", description: "Yapı, tasarım, geliştirme ve kalite kontrolünden geçen yeni web siteleri ve site revizyonları.", status: "preview", statusLabel: "Önizleme", href: "/tr/factories/web", example: "Mimarlık stüdyom için üst düzey, iki dilli bir web sitesi oluştur." },
      { name: "Video / Medya", description: "Senaryo, varlık, ses, görüntü işleme ve doğrulamayı kapsayan referans odaklı medya çalışmaları.", status: "preview", statusLabel: "Önizleme", href: "/tr/factories/video", example: "Bu onaylı ürün görsellerini kullanarak 20 saniyelik lansman videosu oluştur." },
      { name: "Yazılım", description: "Sınırlandırılmış değişiklik, test, inceleme ve kabul kanıtı içeren kod deposu mühendisliği.", status: "preview", statusLabel: "Önizleme", href: "/tr/factories/software", example: "Bu kod deposu özelliğini uygula, gerekli testleri çalıştır ve inceleme kanıtını döndür." },
      { name: "Uygulama", description: "Uygulama planlama ve sınırlandırılmış üretim; daha geniş mobil ve mağaza yayın yolları ayrı kapılar olarak kalır.", status: "preview", statusLabel: "Önizleme", href: "/tr/factories/app", example: "Kontrollü bir randevu uygulaması planla, geliştir ve yayın hazırlığı listesini hazırla." },
