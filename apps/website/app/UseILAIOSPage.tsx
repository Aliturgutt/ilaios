...
const copy = {
  en: {
    ...
    commercialEyebrow: "Commercial use model",
    commercialTitle: "Customers buy the digital production outcome, not hidden provider complexity.",
    commercialLead: "ILAIOS separates eligible zero-cost execution from work that requires a priced external provider. This section explains the commercial model; current technical availability remains separately represented by the readiness labels on this page.",
    commercial: [["01","What is purchased","A digital production service that delivers the selected website, software or application work, research or document, or media outcome."],["02","When a paid cost exists","Eligible zero-cost resources can be used without a paid-provider charge. A priced model, video, image or other external provider creates a paid cost for that job."],["03","Before paid execution","The commercial flow is designed to show the applicable amount before paid execution and require the necessary user and budget approval before a paid provider is used."]],
  ...
  tr: {
    ...
    commercialEyebrow: "Ticari kullanım modeli",
    commercialTitle: "Kullanıcı gizli sağlayıcı karmaşasını değil, dijital üretim sonucunu satın alır.",
    commercialLead: "ILAIOS, uygun sıfır maliyetli yürütmeyi ücretli dış sağlayıcı gerektiren işten ayırır. Bu bölüm ticari kullanım modelini açıklar; güncel teknik erişilebilirlik bu sayfadaki durum etiketleriyle ayrıca gösterilir.",
    commercial: [["01","Ne satın alınır?","Seçilen web sitesi, yazılım veya uygulama işi, araştırma veya doküman ya da medya sonucunu teslim eden dijital üretim hizmeti."],["02","Ne zaman ücretli maliyet oluşur?","Uygun sıfır maliyetli kaynaklarla yürütülebilen işlerde ücretli sağlayıcı maliyeti oluşmaz. Ücretli model, video, görsel veya başka bir dış sağlayıcı gerektiğinde ilgili iş için ücretli maliyet oluşur."],["03","Ücretli yürütmeden önce","Ticari akış; ücretli yürütmeden önce uygulanacak tutarı göstermeyi ve ücretli sağlayıcı kullanılmadan önce gerekli kullanıcı ve bütçe onayını almayı esas alır."]],
