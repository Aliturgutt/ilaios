...
const copy = {
  ...
  tr: {
    ...
    factoryData: [
      ...
      { name: "Uygulama", description: "Uygulama planlama ve sınırlandırılmış üretim; daha geniş mobil ve Store yolları ayrı kapılar olarak kalır.", status: "preview", statusLabel: "Önizleme", href: "/tr/factories/app", example: "Kontrollü bir randevu uygulaması planla, geliştir ve release-readiness listesini hazırla." },
      ...
      { name: "Creative / Doküman", description: "Kontrollü doküman oluşturma ve incelenebilir dışa aktarma yolları.", status: "development", statusLabel: "Geliştiriliyor", href: "/tr/factories/creative-document", example: "Bu onaylı kaynak dokümanlardan incelenebilir bir yönetici raporu oluştur." },
      { name: "Commerce / Büyüme", description: "Kanıta dayalı öneriler ve inceleme kapılı büyüme çalışmaları.", status: "development", statusLabel: "Geliştiriliyor", href: "/tr/factories/commerce-growth", example: "Bu doğrulanmış performans girdilerinden bir büyüme deneyi planı hazırla." },
