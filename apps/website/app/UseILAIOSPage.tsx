...
const copy = {
  en: {
    ...
    plans: [
      ...
      { name: "Enterprise", price: "Custom quote", summary: "Contract-based capacity for organizations that need larger teams, controls, support or provider budgets.", included: ["9/9 production areas", "Contract-defined premium AI and media capacity", "Custom project, automation and concurrency limits", "100 GB+ storage according to need", "Organization-sized workspace", "Contract-defined security controls, support and SLA options"], note: "Capacity and pricing are defined by the approved commercial agreement; there is no hidden automatic overage." },
    ] as readonly Plan[],
