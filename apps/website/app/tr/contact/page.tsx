...
export const metadata: Metadata = {
  title: "İletişim",
  description: "ILAIOS resmi iletişim kanallarının mevcut durumu ve doğrulama bilgileri.",
  alternates: { canonical: "/tr/contact", languages: { tr: "/tr/contact", en: "/contact", "x-default": "/contact" } },
};

export default function Page(){return <>
  <section className="shell page-hero"><div className="eyebrow">İletişim</div><h1>ILAIOS resmi iletişim kanalları.</h1><p className="lead">ILAIOS aktif geliştirme aşamasındadır. İş, ortaklık, ürün ve güvenlik kanalları yalnızca ilgili kurumsal mailbox dış kullanıma doğrulandıktan sonra yayınlanır.</p></section>
