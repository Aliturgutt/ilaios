...
const solutions = [
  ...
  ["Dijital iş operasyonları", "Görevları, süreçleri, yürütme izlemeyi, istisnaları ve onay kapılı iş eylemlerini koordine eder; iş fonksiyonlarını otonom departmanlara dönüştürmez.", ["İş kurallarını model yetkisinin dışında tut", "Hassas veya geri döndürülemez eylemleri eskale et", "Operasyonel kanıtı koru"]],
