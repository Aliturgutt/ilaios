...
export const metadata: Metadata = {
  title: "Web Factory",
  description: "ILAIOS Web Factory: hedef ve araştırmadan bilgi mimarisi, görsel tasarım, implementation, browser/security/accessibility/performance/SEO/visual QA, bounded repair, deployment validation ve finished-site evidence'a uzanan kanonik workflow.",
...
export default function Page() { return <>
  ...
  <section className="section surface-section"><div className="shell"><div className="section-heading"><div><div className="eyebrow">Tam yaşam döngüsü</div><h2>Kanonik zincir tüm kalite kapılarını görünür kılar.</h2></div><p>Web sitesi hedefi → Araştırma → Bilgi mimarisi → Metin → Design System → Görsel tasarım → Implementation → Browser QA → Security QA → Accessibility → Performance → SEO → Visual QA → Acceptance → bounded repair → Deployment Validation → Bitmiş site + Evidence.</p></div><CanonicalSystemDetail locale="tr" variant="web" /></div></section>
