...
export default function Page(){return <>
  <section className="shell page-hero compact-page-hero resources-hero" style={{paddingTop:"30px",paddingBottom:"26px"}}><div className="eyebrow">Kaynaklar</div><h1>ILAIOS'un arkasındaki mühendislik yaklaşımı.</h1><p className="lead">Ürün mimarisi, güvenlik ve kontrollü otomasyon üzerine yazılar. Resources yaklaşımı açıklar; Docs teknik referansı taşır.</p></section>
