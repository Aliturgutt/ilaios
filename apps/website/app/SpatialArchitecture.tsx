...
const copy: Record<Locale, { label: string; aria: string; hint: string; nodes: Node[] }> = {
  ...
  tr: {
    ...
    nodes: [
      ...
      { title: "Üretim", detail: "Sınırlandırılmış yürütme", description: "Onaylı sınırlandırılmış DAG'ı uygun yerleşik üretim alanı ve yönetilen çalışan/araç/sağlayıcı yolu üzerinden yürütür. Üretim alanları, alan yürütme yüzeyleridir; paralel kontrol düzlemleri değildir." },
