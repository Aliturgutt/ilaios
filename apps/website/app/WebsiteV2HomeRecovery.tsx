...
export default function WebsiteV2HomeRecovery({ locale }: { locale: Locale }) {
  ...
  return <main className="v2-recovery-home">
    ...
    <style>{`
      ...
      .v2-hero-visual{border-radius:12px!important}.v2-hero-visual figcaption{font-size:.78rem!important}
