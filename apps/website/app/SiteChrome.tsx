    ...
    <footer className="site-footer" lang={lang}>
      <div className="shell footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-primary-contact"><a href="mailto:contact@ilaios.com">contact@ilaios.com</a></div>
          <div className="footer-social" aria-label={isTr ? "ILAIOS sosyal hesapları" : "ILAIOS social profiles"}>
