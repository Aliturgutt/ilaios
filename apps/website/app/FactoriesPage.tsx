...
export default function FactoriesPage({ locale }: { locale: Locale }) {
  ...
  return <>
    ...
    <section className="section"><div className="shell"><div className="architecture-story-copy"><div className="eyebrow">{c.sharedEyebrow}</div><h2>{c.sharedTitle}</h2><p>{c.sharedLead}</p></div></div></section>
