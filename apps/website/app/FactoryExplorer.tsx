...
const data = {
  ...
  tr: {
    ...
    open: "Alanı aç",
    factories: [
      { label: "Web", short: "Web sitesi üretimi", pipeline: ["Gereksinim", "Tasarım", "Geliştirme", "Tarayıcı QA", "Yayın kanıtı"], result: "Doğrulanmış bitmiş site paketi", boundary: "Yayın için açık release yetkisi ve kesin yayın eşleştirmesi gerekir.", href: "/tr/factories/web" },
      ...
      { label: "Yazılım", short: "Kod deposu mühendisliği", pipeline: ["Bağlam", "Plan", "Değişiklik", "Testler", "İnceleme kanıtı"], result: "Test edilmiş sınırlandırılmış değişiklik", boundary: "Kod deposu ve politika kapsamı araç, dosya ve merge yetkisini sınırlar.", href: "/tr/factories/software" },
      { label: "Uygulama", short: "Uygulama sonuçları", pipeline: ["Kapsam", "Değişiklik planı", "Derleme planı", "Testler", "İnceleme"], result: "İncelenebilir uygulama sonucu", boundary: "Mevcut temel imzalama, mağaza veya yayın yetkisini sessizce edinmez.", href: "/tr/factories/app" },
      ...
      { label: "Büyüme", short: "İnceleme odaklı büyüme", pipeline: ["Kanıt", "Öneri", "Taslak", "İnceleme", "Karar"], result: "Kanıta dayalı büyüme önerisi", boundary: "Ücretli harcama veya yayınlama yetkisi factory adıyla verilmez.", href: "/tr/factories/commerce-growth" },
      { label: "Kişisel Operasyon", short: "İncelenebilir kişisel işler", pipeline: ["Hedef", "Bağlam", "Taslak plan", "İnceleme", "Onaylı işlem"], result: "İnceleme odaklı kişisel operasyon planı", boundary: "Takvim, e-posta ve hatırlatıcı dış etkileri ayrıca yönetilir.", href: "/tr/factories/personal-operations" },
    ] as readonly Factory[],
  },
} as const;
