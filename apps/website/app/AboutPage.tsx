...
const copy = {
  ...
  tr: {
    ...
    principles: [["Kolaylıktan önce kontrol", "Bir model işlem yapabiliyor diye otomasyon yetkiyi genişletmez."], ["Güvenden önce kanıt", "Önemli sonuçlar ne olduğunu, neyin geçtiğini ve neden kabul edildiğini gösterebilir."], ["Arayüzden önce mimari", "Web, Masaüstü, Mobil ve diğer istemciler backend yetkisinin görünümüdür."]],
    founderLabel: "Kurucu",
    founder: "Ali Turgut",
    founderText: "Ali Turgut, ILAIOS'u kurdu ve yönetilen akıllı otomasyon, güvenli yürütme, yerleşik üretim iş akışları ve kanıta dayalı sistemler alanındaki ürün yönünü yönetiyor.",
    truthLabel: "Ürün gerçeği",
    truth: "ILAIOS aktif geliştirme aşamasındadır. Kamuya açık içerikler kanonik ürün yönünü güncel uygulama, doğrulama, deployment ve genel kullanıma açıklık durumundan bilinçli olarak ayırır.",
    solutions: "Çözümler",
    architecture: "Mimari",
  },
} as const;
