...
export default function Page(){return <>
  <section className="shell page-hero compact-page-hero resources-hero"><div className="eyebrow">Resources</div><h1>Engineering perspectives behind ILAIOS.</h1><p className="lead">Articles on product architecture, security and governed automation. Resources explains the thinking; Docs carries the technical reference.</p></section>
