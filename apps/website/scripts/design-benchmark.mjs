...
requireText(home, "Explore all nine production areas.", "nine-area English homepage bridge");
requireText(home, "Dokuz üretim alanının tamamını keşfet.", "nine-area Turkish homepage bridge");
...
requireText(product, "Nine illustrative workflow previews", "nine-area preview label");
requireText(product, "does not run providers, start production work or perform external actions", "English preview truth boundary");
requireText(product, "Dokuz örnek iş akışı", "Turkish nine-area preview label");
requireText(product, "gerçek üretim işi başlatmaz veya dış sistemlerde işlem yapmaz", "Turkish preview truth boundary");
