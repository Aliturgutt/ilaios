...
Core/Security skills are defined once here as bounded first-party instructions.
Engineering does not get a parallel skill family: its ten primary runtime skills
are loaded from the already canonical SF-7 packages under
``tools/software-factory/skills`` after the complete 25-package registry passes
validation.
"""
...
def provision_engineering_primary_skills(
    ...
    for binding in P0_AGENT_BINDINGS:
        ...
        instructions_path = package.root / "SKILL.md"
