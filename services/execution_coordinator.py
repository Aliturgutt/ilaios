...
class ExecutionCoordinator:
    ...
    def prepare(
        ...
        *,
        ...
        if len(routes) == 1 and not blockers:
            ...
            blocker_code = (
                "MULTI_CAPABILITY_ADAPTER_SET_INCOMPLETE"
                if len(routes) > 1
    ...
    def recover_stale(
        ...
        """Close stale active requests and all subordinate durable resources."""
    ...
    def recover(self, *, token: str, now: datetime) -> dict[str, int]:
        """Startup recovery summary over the stronger stale-closure primitive."""
