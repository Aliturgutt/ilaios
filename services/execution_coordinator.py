...
This module composes existing Control Plane, governance, scheduler, grant and
finished-product adapter boundaries. It does not create a second runtime or
factory. Capability selection is deliberately conservative and fails closed
when a prompt is ambiguous or no verified finished-product adapter exists.
"""
