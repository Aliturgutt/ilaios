...
def actual_cost_microusd_from_observation(
    ...
    Settlement deliberately fails closed when terminal evidence has no provider
    cost. The reservation must remain held until billing reconciliation instead
    of silently treating missing cost as zero.
    """
