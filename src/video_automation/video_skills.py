...
VIDEO_SKILLS: tuple[VideoSkillManifest, ...] = (
    ...
    VideoSkillManifest(
        ...
        "1.0.0",
        "ilaios.capability.video-media-factory",
        "src.video_automation.prompting_skills:VideoDirector",
        SkillRisk.READ_ONLY,
        ("manifest.read",),
    ),
    VideoSkillManifest(
        ...
        "1.0.0",
        "ilaios.capability.video-media-factory",
        "src.video_automation.prompting_skills:VideoPromptComposer",
        SkillRisk.READ_ONLY,
        ("manifest.read",),
    ),
    VideoSkillManifest(
        ...
        "1.0.0",
        "ilaios.capability.video-media-factory",
        "src.video_automation.prompting_skills:ReferenceAssetPlanner",
        SkillRisk.READ_ONLY,
        ("manifest.read", "media.read"),
    ),
    VideoSkillManifest(
        "ilaios.skill.video.routing.model-advice",
        "1.0.0",
        "ilaios.capability.video-media-factory",
        "src.video_automation.prompting_skills:VideoModelRoutingAdvisor",
        SkillRisk.READ_ONLY,
        ("manifest.read",),
    ),
    VideoSkillManifest(
        ...
        "1.0.0",
        "ilaios.capability.video-media-factory",
        "src.video_automation.prompting_skills:VideoContinuityPlanner",
        SkillRisk.READ_ONLY,
        ("manifest.read",),
    ),
    VideoSkillManifest(
