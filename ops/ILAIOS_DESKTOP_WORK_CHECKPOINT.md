...
- Working branch: `desktop/live-workspace-authority-current-20260819-v3`
- Fresh base: `master@c0e6e9306a520eb917ccbbde8cacd820155ef108`
...
- PR #515 proved the regression on an older base; PR #520 replayed the repair on `f75a0c35...` but master advanced through non-overlapping Mobile Store checkpoint PR #517 before merge authority could be established. Both are superseded by this exact-current-master replay.
